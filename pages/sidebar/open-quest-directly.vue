<template>
  <div class="">
    <div class="h-dvh overflow-hidden flex items-center justify-center text-white bg-fuchsia-950">
      <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Open Quest Directly</h1>
            <p class="mt-6 text-lg leading-8 text-gray-400">Click on the button in the lower right corner of the screen
              to see how the Open Quest Directly Widget would work.</p>
          </div>
        </div>
        <div
